  ...
  return (
    <div className="container">
      <div className="page-header">
        <h1><FaBook /> Documentation de l'API</h1>
      </div>
      ...
      <div className="card fade-in mb-4">
        ...
        <div className="card-body">
          <p>
            ...
            les réservations et les utilisateurs. Toutes les routes (sauf /login) 
            nécessitent une authentification via JWT.
          </p>
          <p><strong>URL de base :</strong> <code>/api</code></p>
        </div>
      </div>
          ...
          <div className="table-responsive">
            <table className="table">
              ...
              <tbody>
                ...
                <tr>
                  <td><span className="badge badge-primary">GET</span></td>
...
{`{
  ...
  "catwayState": "Bon état"    // Description de l'état
      ...
      <div className="card fade-in mb-4">
        <div className="card-header">
          <h3><FaCalendarAlt /> Réservations</h3>
        </div>
        <div className="card-body">
          <div className="table-responsive">
            <table className="table">
          ...
          <div className="table-responsive">
            <table className="table">
              ...
              <tbody>
                ...
                <tr>
                  <td><span className="badge badge-warning">400</span></td>
                ...
                <tr>
                  <td><span className="badge badge-warning">404</span></td>
