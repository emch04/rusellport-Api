  ...
  return (
    <div className="container">
      ...
      <div className="page-header">
        <button onClick={() => navigate('/catways')} className="btn btn-secondary">
          <FaArrowLeft /> Retour
        </button>
        <h1><FaShip /> Détails du Catway #{id}</h1>
      </div>
          ...
          <div className="card-body">
            <div className="detail-grid">
              ...
              <div className="detail-item">
                ...
                <span className="detail-value">{catway.catwayType === 'long' ? 'Long (Grand bateau)' : 'Court (Petit bateau)'}</span>
              </div>
              <div className="detail-item">
            ...
            <div className="btn-group mt-4">
              <button onClick={() => navigate(`/catways/${id}/edit`)} className="btn btn-warning">
                <FaEdit /> Modifier les infos
              </button>
              <button onClick={() => navigate(`/catways/${id}/reservations/create`)} className="btn btn-primary">
